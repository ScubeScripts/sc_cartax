...
local resourceName = "sc_cartax"

CreateThread(function()
    if GetCurrentResourceName() ~= "sc_cartax" then
        resourceName = "sc_cartax (" .. GetCurrentResourceName() .. ")"
    end
end)
CreateThread(function()
    while true do
        PerformHttpRequest("https://api.github.com/repos/ScubeScripts/sc_cartax/releases/latest", CheckVersion, "GET")
        Wait(3600000)
    end
end)
...
function GetRepoInformations()
    ...
    PerformHttpRequest("https://api.github.com/repos/ScubeScripts/sc_cartax/releases/latest", function(err, response)
        if err == 200 then
            ...
            repoURL = "https://github.com/ScubeScripts/sc_cartax"
        end
    end, "GET")
    repeat
        Wait(50)
